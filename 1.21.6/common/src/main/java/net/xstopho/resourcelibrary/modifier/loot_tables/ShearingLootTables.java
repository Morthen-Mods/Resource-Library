...
public class ShearingLootTables {
    ...
    public static final ResourceKey<LootTable> BROWN = createKey("shearing/mooshroom/brown");
    public static final ResourceKey<LootTable> RED = createKey("shearing/mooshroom/red");
