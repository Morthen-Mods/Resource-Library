...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> FURNACE_LIKE_BLOCK = register("furnace_like_block", () -> new FurnaceBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.FURNACE)));
