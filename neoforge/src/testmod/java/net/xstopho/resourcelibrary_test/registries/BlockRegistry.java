...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> FURNACE_LIKE_BLOCK = register("furnace_like_block",
    ...
    public static RegistryObject<Block> register(String id, Supplier<Block> block) {
        ...
        ItemRegistry.register(id, () -> new BlockItem(toReturn.get(), new Item.Properties()
                .setId(ResourceKey.create(BuiltInRegistries.ITEM.key(), ResourceLocation.fromNamespaceAndPath(ResourceLibraryTest.MOD_ID, id)))));
        return toReturn;
    }
    ...
    public static RegistryObject<Block> register(String id) {
        return register(id, () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE)
                .setId(ResourceKey.create(BuiltInRegistries.BLOCK.key(), ResourceLocation.fromNamespaceAndPath(ResourceLibraryTest.MOD_ID, id)))));
    }
