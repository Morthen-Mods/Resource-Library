...
public class EntityLootTables {
    ...
    public static final ResourceKey<LootTable> CREAKING = createKey("creaking");
    public static final ResourceKey<LootTable> CREAKING_TRANSIENT = createKey("creaking_transient");
