...
public class GameplayLootTables {
    ...
    public static final ResourceKey<LootTable> FISH = createKey("gameplay/fishing/fish");
    public static final ResourceKey<LootTable> JUNK = createKey("gameplay/fishing/junk");
    public static final ResourceKey<LootTable> TREASURE = createKey("gameplay/fishing/treasure");
